...
})({"hO1AP":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "4be9b1fa66128e97";
"use strict";
...
},{}],"dTpWZ":[function(require,module,exports,__globalThis) {
...
form.addEventListener("submit", async (e)=>{
    ...
    try {
        const response = await fetch(`${(0, _config.BASE_API_URL)}/login`, {
            method: "POST",
            credentials: "include",
            headers: {
        ...
        (0, _messageDefault.default)(data.message, 0);
        setTimeout(()=>{
            window.location.href = data.redirect || "/";
        }, 3000);
    } catch (error) {
        (0, _messageDefault.default)("Incorrect email or password", 1);
    }
});
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["hO1AP","dTpWZ"], "dTpWZ", "parcelRequire94c2")

//# sourceMappingURL=signin.66128e97.js.map
