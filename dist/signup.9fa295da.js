...
})({"eL8F3":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "78a2df099fa295da";
"use strict";
...
},{}],"058Jc":[function(require,module,exports,__globalThis) {
...
form.addEventListener("submit", async (e)=>{
    ...
    if (client.password !== client["confirm-password"]) {
        (0, _messageDefault.default)("Passwords do not match", 1);
        return;
    }
    const data = {
        name: client.name,
    ...
    client.secret && (data.secret = client.secret);
    try {
        const response = await fetch((0, _config.BASE_API_URL) + "/signup", {
            method: "POST",
            headers: {
        ...
        (0, _messageDefault.default)(dataResponse.message, 0);
        console.log(dataResponse);
        setTimeout(()=>{
            window.location.href = "/signin";
        }, 2000);
    } catch (error) {
        (0, _messageDefault.default)(error.message, 1);
    }
});

},{"./services/config":"8ermM","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./ui/message":"jwRET"}],"8ermM":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{}],"jwRET":[function(require,module,exports,__globalThis) {
/**
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["eL8F3","058Jc"], "058Jc", "parcelRequire94c2")

//# sourceMappingURL=signup.9fa295da.js.map
